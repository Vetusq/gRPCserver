...
func (x *greeterStreamGetBalanceClient) Recv() (*ResponceBalance, error) {
	m := new(ResponceBalance)
...
func (x *greeterStreamGetBalanceServer) Send(m *ResponceBalance) error {
